      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 my-8"
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto">
              <p className="text-gray-600 text-sm">
                Select duration for blocking this user account. During this period, the user will not be able to <span class="text-red-600/80">Book Any Room</span>
              </p>
                ...
                {[
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">{option.time}</p>
                ...
                <div className="border border-gray-200 rounded-lg p-3 space-y-3">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pl-7">
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-red-500 disabled:opacity-50 text-sm"
                      placeholder="Enter hours"
                    />
                    <span className="text-sm text-gray-500 whitespace-nowrap sm:self-center">
                      Hours
                    </span>
                  </div>
                </div>
