                    ...
                    {(() => {
                      ...
                      return selectedBooking ? (
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                          ...
                          <div className="space-y-1">
                            <span className="block text-xs sm:text-sm text-gray-500 dark:text-gray-400">Status</span>
                            <span className="font-medium text-sm sm:text-base dark:text-gray-200">{selectedBooking.status}</span>
                          </div>
                        </div>
                      ) : null;
                    })()}
