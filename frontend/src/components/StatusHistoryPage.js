  ...
  return (
    <div className="min-h-screen p-8 max-w-6xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Past system status updates and incidents</p>
      </div>
      {history.length > 0 ? (
      <div className="space-y-6">
        {history.map((entry, index) => {
          ...
          return (
            <div key={index} className={`${statusConfig.color} rounded-lg p-6 shadow-sm`}>
              ...
              {entry.services && Object.keys(entry.services).length > 0 && (
                <div className="mt-4 pt-4 border-t border-opacity-20">
                  <h4 className="text-sm font-medium mb-2">Service Statuses:</h4>
