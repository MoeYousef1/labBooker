...
const themes = {
  blue: {
    ...
    focus: "focus:ring-blue-600 focus:border-blue-600 dark:focus:ring-blue-500 dark:focus:border-blue-500",
  },
  green: {
    primary: "green",
    ...
    focus: "focus:ring-green-500 focus:border-green-500 dark:focus:ring-green-500 dark:focus:border-green-500",
  },
};
...
/>
      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-40">
          <div ref={popupRef} className="bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-xl shadow-lg dark:shadow-xl dark:shadow-gray-950/50 w-full max-w-md mx-4">
            {/* Calendar Header */}
...
>
              ...
              <div className="text-lg font-medium text-gray-700 dark:text-gray-200">{monthYearText}</div>
              <button
